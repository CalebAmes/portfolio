		...
		<div style={fontAdjuster} className="allPokemonPage">
			<div className="topLeft">
				<div className="buttonGroup">
					<button value="dark" onClick={(e) => changeTheme(e)} className="styled_button">
						Dark
					</button>
					<button value="light" onClick={(e) => changeTheme(e)} className="styled_button">
						Light
					</button>
					<button value="red" onClick={(e) => changeTheme(e)} className="styled_button">
						Red
					</button>
					<button value="blue" onClick={(e) => changeTheme(e)} className="styled_button">
						Blue
					</button>
					<button
						style={pageFontSize >= 20 ? dontClick : {}}
						onClick={() => setPageFontSize(() => (pageFontSize < 20 ? pageFontSize + 1 : pageFontSize))}
			...
			<div className="more_info">
				<p>
					I am a tinkerer first. If I can take it apart and see how it works, chances are I have. If I can
					modify it, chances are that I will. My preferred tools are JavaScript, React, Redux, Express,
					Sequelize, and SQL however I also enjoy Python and how easy it makes working with data, especially
					when paired with Flask and SQLAlchemy. This said I can learn anything and am always eager for the
					challenge. Send me a message and let's get the conversation started.
				</p>
			</div>
			...
			<div className="showcase">
				<div className="showcase__grid">
					...
					<div className="showcase__grid-item">
						<h3>DESCRIPTION</h3>
						<p>
							Taking inspiration from Slack and Discord this group chat application hosts a powerhouse of
							features such as Themes, Autocomplete, Realtime messaging, updating and deleting to any
							number of clients. It also has a fully featured Electron Frontend that can be packaged into
							a Native desktop application for Mac, Windows or Linux. This version also includes
							Notifications.
						</p>
					</div>
					<div className="showcase__grid-item">
				...
				<div className="messageShrewdness__div">
					...
					<p>
						This is fully integrated with the Shrewdness socket and will allow you to interact with the
						Gorillas - General Channel
					</p>
					<MessageShrewdness />
				</div>
			</div>
			...
			<div className="showcase reverseFlex">
				<div className="showcase__grid reverseGrid">
					...
					<div className="showcase__grid-item">
						<h3>DESCRIPTION</h3>
						<p>
							This event planner for dogs is loosely inspired by Meetup.com and highlights how powerful a
							minimalist and modern UI can be when paired with a single page React application.
						</p>
					</div>
				</div>
